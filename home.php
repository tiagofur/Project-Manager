...
<html lang="es-mx">
	<head>
		...
		<?php
			...
			$selectProjects = $project_action->selectAllProjects($start, $quant_result_pg);
        ?>
	</head>
	...
	<body>
		...
		<div class="container col-md-12">
			<div class="row">
				<div class="col-md-12">
					<h3 class="titulo-pagina">Todos Proyectos</h3>
				...
				<?php	if(($selectProjects) AND ($selectProjects->num_rows != 0)){ ?>
					...
					<table class="table border border-success">
						<thead class="light-green lighten-3">
							<tr>
								...
								<th>Entrega</th>
								<th class="d-none d-lg-table-cell">Situacion</th>
								<th>Accion</th>
							</tr>
						</thead>
							...
							<?php while($row_projects = mysqli_fetch_assoc($selectProjects)) { ?>
								...
								?>
									...
									<th class="d-none d-lg-table-cell">
										<?php
										if($row_projects['P_VALIDADO'] == 0){
											echo "No Validado";
										}
										if($row_projects['P_VALIDADO'] == 1){
											echo "Validado";
										}
										?>
									</th>
					...
					<?php
						...
						$quant_total = "SELECT COUNT(id) AS NUM_RESULT FROM projects";
						...
						echo "<a class='page-link' href='http://creapolis.mx/project-manager/home.php?page=1' tabindex='-1'>Primera</a>";
						echo "</li>";

						for($page_before = $page - $max_links; $page_before <= $page -1; $page_before++){
							if($page_before >= 1){
								echo "<li class='page-item'><a class='page-link' href='http://creapolis.mx/project-manager/home.php?page=".$page_before."'>".$page_before."</a></li>";
							}
						}
						...
						for($page_after = $page + 1; $page_after <= $page +$max_links; $page_after++){
							if($page_after <= $quant_pg){
								echo "<li class='page-item'><a class='page-link' href='http://creapolis.mx/project-manager/home.php?page=".$page_after."'>".$page_after."</a></li>";
							}
						}

						echo "<li class='page-item'>";
						echo "<a class='page-link' href='http://creapolis.mx/project-manager/home.php?page=".$quant_pg."'>Ultima</a>";
						echo "</li>";
						echo "</ul>";
						echo "</nav>";
					?>
