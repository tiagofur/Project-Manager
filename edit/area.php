        ...
        <?php
            ...
            if(isset($_GET['areaid'])){
                ...
                if(mysqli_query($link, $sql)){
                    ...
                    $row_area = mysqli_fetch_assoc($resultSeresultSelectlectClient);
                ...
                <div class="col-md-8 border-right-form">
                    ...
                    <form action="../php/update-area.php" method="post" id="form-edit-area">
                        <div class="form-group" hidden>
                            ...
                            <input type="text" class="form-control" id="id" name="id" value="<?php echo $row_area['A_ID']; ?>" required>
                        </div>

                        <div class="form-group">
                            <label for="nome">Nombre</label>
                            <input type="text" class="form-control" id="nome" name="nome" value="<?php echo $row_area['A_NOME']; ?>" required>
                        </div>

                        <div class="form-group">
                            <label for="gerente">Gerente</label>
                            <select name="gerente" id="gerente" class="form-control" required>
                                <option value="<?php echo $row_area['A_GERENTE']; ?>"><?php echo $row_area['U_NOME'] . ' ' . $row_area['U_SOBRENOME']; ?></option>
